<script lang="ts">
	...
	const ogImageUrl = $derived(buildAuthorOgImageUrl('prompts', data.author.slug));
...
<svelte:head>
	...
	<meta property="og:image:alt" content="{data.author.name} - Prompt Library | Bearprompt" />
	...
	<meta name="twitter:image:alt" content="{data.author.name} - Prompt Library | Bearprompt" />
